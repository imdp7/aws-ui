      ...
      >
        <SpaceBetween size="xs">
          <FormField
            ...
            errorText={
              errorMessage &&
              errorMessage.includes('configuration name') &&
              errorMessage
            }
          >
            <Input
          ...
          {scope == 'filter' && (
            <SpaceBetween size="xs">
              <FormField
                ...
                errorText={
                  errorMessage &&
                  errorMessage.includes('prefix or tags') &&
                  errorMessage
                }
              >
                <Input
          ...
          <FormField
            label="Status"
            description="Choose whether the configuration will be enabled or disabled."
          />
          <RadioGroup
            value={status}
            items={[
        ...
        <SpaceBetween size="m">
          ...
          >
            ...
            {archieve && (
              <SpaceBetween size="s">
                <FormField
                  label="Days until transition to the Archive Access tier"
                  ...
                  errorText={
                    errorMessage &&
                    errorMessage.includes('A valid integer is required.') &&
                    errorMessage
                  }
                >
                  <Input
                ...
                <Alert type="info">
                  <>
                    Only activate the Archive Access tier for 90 days if you
                    want to bypass the Archive Instant Access tier. The Archive
                    Access tier delivers 10% lower storage cost with minute to
                    hour retrieval times, whereas the Archive Instant Access
                    tier delivers the same milliseconds access times as the
                    Frequent and Infrequent Access tiers. Learn more about the{' '}
                    <Link external fontSize="inherit">
            ...
            {deepArchieve && (
              <SpaceBetween size="s">
                <FormField
                  label="Days until transition to the Deep Archive Access tier"
            ...
            {archieve || deepArchieve ? (
              <Alert type="warning" header="Retrieval time compatibility">
                <>
                  To access objects that have moved to the Intelligent-Tiering
                  Archive Access tier, you must restore them back to the
                  Frequent Access tier which can take up to 5 hours from the
                  Archive Access tier, and 12 hours from the Deep Archive Access
                  tier. Ensure that this retrieval time is compatible with your
                  application.
                </>
              </Alert>
            ) : null}
