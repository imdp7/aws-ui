      ...
      <SpaceBetween size="xs">
        ...
        <RadioGroup
          ...
          items={[
            ...
            {
              value: 'all',
              label: 'This configuration applies to all objects in the bucket',
            },
          ]}
          ...
          <SpaceBetween size="s">
            ...
            <Alert type="info">
              <>
                ...
                bypass the Archive Instant Access tier. The Archive Access tier
                delivers 10% lower storage cost with minute to hour retrieval
                times, whereas the Archive Instant Access tier delivers the same
                milliseconds access times as the Frequent and Infrequent Access
                tiers. Learn more about the{' '}
        ...
        {archieve || deepArchieve ? (
          <Alert type="warning" header="Retrieval time compatibility">
            <>
              ...
              Archive Access tier, you must restore them back to the Frequent
              Access tier which can take up to 5 hours from the Archive Access
              tier, and 12 hours from the Deep Archive Access tier. Ensure that
              this retrieval time is compatible with your application.
            </>
          </Alert>
        ) : null}
      </SpaceBetween>
