...
const StorageConfigure = (props) => {
  ...
  return (
    <SpaceBetween size="m">
      <Container header={<Header variant="h2">Name</Header>}>
        <SpaceBetween size="m">
          <FormField
            ...
            description="Once created, the configuration name can't be changed."
            constraintText="Name can only contain letters, numbers, periods, dashes, and underscores."
            errorText={
              errorMessage &&
              errorMessage.includes('Config name') &&
              errorMessage
            }
          >
            <Input
      ...
      <Container
        header={
          <Header variant="h2" description="Specify scope to analyze">
            Configure scope
          </Header>
        }
      >
                ...
                >
                  <S3ResourceSelector
                    ...
                    i18nStrings={{
                      ...
                      labelNotSorted: (columnName) =>
                        columnName + ', not sorted',
                      labelsPagination: {
...
export default StorageConfigure;
