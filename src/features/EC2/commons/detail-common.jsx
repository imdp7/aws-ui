  ...
  return (
    <Container header={<Header variant="h3"
     ...
     <ButtonDropdown items={[
        { text: "Create status check alarm", id: "create", disabled: false },
        { text: "Report Instance status", id: "report", disabled: false },
      ]}
      >
      Actions
      </ButtonDropdown>
...
export function Networking() {
  ...
  return (
    ...
    <SpaceBetween size="s">
      ...
      <ExpandableSection headerText="Network Interfaces" headerCounter="1" defaultExpanded>
         <Table
        columnDefinitions={[
        {
          id: "id",
      ...
      items={[
        ...
        IPv6addresses: "-",
        AttachmentTime: "Tue Feb 28 2023 04:44:10 GMT-0500 (Eastern Standard Time) (about 22 hours)",
  ...
  return (
    ...
    <ExpandableSection headerText="Root device details" defaultExpanded>
      <ColumnLayout columns={3} variant="text-grid">
        ...
        <FormField label="Root device type">
          EBS
        </FormField>
        <FormField label="EBS optimization">
          disabled
        </FormField>
      </ColumnLayout>
      </ExpandableSection>
      ...
      <ExpandableSection headerText="Block device" defaultExpanded>
       <Table
        ...
        { id: "size", header: "Volume Size", cell: e => e.size },
        {
          id: "status",
          header: "Attachment status",
          cell: e => <StatusIndicator type="success">{e.status}</StatusIndicator>
        },
        {
          id: "time",
          header: "Attachment time",
    ...
    />
      ...
      <ExpandableSection headerText="Recent root volume replacement tasks" defaultExpanded>
       <Table
        columnDefinitions={[
        {
          id: "id",
        ...
        },
        {
          id: "state",
          header: "Task state",
          cell: e => <StatusIndicator type="success">{e.state}</StatusIndicator>
        },
        {
          id: "StartTime",
          header: "Start time",
      ...
      empty={
        <Box textAlign="center" color="inherit">
          <b>No Recent root volume replacement tasks are associated with this instance</b>
        </Box>
      }
     filter={
        <TextFilter
