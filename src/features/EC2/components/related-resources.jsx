    ...
    >
      <ColumnLayout columns={2} variant="text-grid">
        <div>
          ...
          <Box variant="p">
            Amazon EC2 Auto Scaling now lets you provision and automatically
            scale instances across purchase options, Availability Zones (AZ),
            and instance families in a single Auto Scaling group (ASG), to
            optimize scale, performance, and cost.
          </Box>
          <Box padding={{ vertical: 'xxs' }}>
            <Link href="#" {...externalLinkProps}>
              Learn more
        ...
        <div>
          ...
          <Box variant="p">
            Amazon EC2 expands Hibernation support for Amazon Linux 2. You can
            now hibernate newly launched EC2 Instances running Amazon Linux 2,
            in addition to Amazon Linux and Ubuntu 18.04 LTS OS.
          </Box>
          <Box padding={{ vertical: 'xxs' }}>
            <Link href="#" {...externalLinkProps}>
              Learn more
